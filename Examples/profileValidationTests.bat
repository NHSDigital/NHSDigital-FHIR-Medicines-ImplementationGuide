...
java -jar org.hl7.fhir.validator.jar PractitionerRole-pass.xml -version 4.0.1 -tx https://r4.ontoserver.csiro.au/fhir -ig https://packages.simplifier.net/UK.DM.r4/-/UK.DM.r4-0.1.5-alpha.tgz  -profile https://fhir.nhs.uk/StructureDefinition/NHSDigital-PractitionerRole



rem FAIL - [Patient] 

java -jar org.hl7.fhir.validator.jar Patient-PDS-fail.json -version 4.0.1 -tx https://r4.ontoserver.csiro.au/fhir -ig https://packages.simplifier.net/UK.DM.r4/-/UK.DM.r4-0.1.5-alpha.tgz  -profile https://fhir.nhs.uk/StructureDefinition/NHSDigital-Patient

rem PASS - [Patient] 

java -jar org.hl7.fhir.validator.jar Patient-EPS-pass.json -version 4.0.1 -tx https://r4.ontoserver.csiro.au/fhir -ig https://packages.simplifier.net/UK.DM.r4/-/UK.DM.r4-0.1.5-alpha.tgz  -profile https://fhir.nhs.uk/StructureDefinition/NHSDigital-Patient



rem PASS - [Practitioner] 

java -jar org.hl7.fhir.validator.jar Practitioner.xml -version 4.0.1 -tx https://r4.ontoserver.csiro.au/fhir -ig https://packages.simplifier.net/UK.DM.r4/-/UK.DM.r4-0.1.5-alpha.tgz  -profile https://fhir.nhs.uk/StructureDefinition/NHSDigital-Practitioner



rem PASS - [Organization] 

java -jar org.hl7.fhir.validator.jar Organization.xml -version 4.0.1 -tx https://r4.ontoserver.csiro.au/fhir -ig https://packages.simplifier.net/UK.DM.r4/-/UK.DM.r4-0.1.5-alpha.tgz  -profile https://fhir.nhs.uk/StructureDefinition/NHSDigital-Organization

rem PASS - [Organisation-2] 

java -jar org.hl7.fhir.validator.jar Organisation-2.json -version 4.0.1 -tx https://r4.ontoserver.csiro.au/fhir -ig https://packages.simplifier.net/UK.DM.r4/-/UK.DM.r4-0.1.5-alpha.tgz  -profile https://fhir.nhs.uk/StructureDefinition/NHSDigital-Organization
